...
```{r my_plot}
covid_data_count |> 
  filter(race == "Total", state_name == "Florida") |> 
...
It would be useful if we had data from further into the year and the amount of vaccinations carried out for each race and state, so we could see if that effects the amount of hospitalizations.
